...
class ApprovalStatusController extends Controller
{
    public function index()
    {
        ...
        return view('admin.approvalStatuses.index', compact('approvalStatuses'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.approvalStatuses.create');
    }
    ...
    public function store(StoreApprovalStatusRequest $request)
    {
        ...
        return redirect()->route('admin.approval-statuses.index');
    }
    ...
    public function edit(ApprovalStatus $approvalStatus)
    {
        ...
        return view('admin.approvalStatuses.edit', compact('approvalStatus'));
    }
    ...
    public function show(ApprovalStatus $approvalStatus)
    {
        ...
        return view('admin.approvalStatuses.show', compact('approvalStatus'));
    }
