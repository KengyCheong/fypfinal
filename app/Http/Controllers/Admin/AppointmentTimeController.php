...
class AppointmentTimeController extends Controller
{
    public function index()
    {
        ...
        return view('admin.appointmentTimes.index', compact('appointmentTimes'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.appointmentTimes.create');
    }
    ...
    public function store(StoreAppointmentTimeRequest $request)
    {
        ...
        return redirect()->route('admin.appointment-times.index');
    }
    ...
    public function edit(AppointmentTime $appointmentTime)
    {
        ...
        return view('admin.appointmentTimes.edit', compact('appointmentTime'));
    }
    ...
    public function show(AppointmentTime $appointmentTime)
    {
        ...
        return view('admin.appointmentTimes.show', compact('appointmentTime'));
    }
