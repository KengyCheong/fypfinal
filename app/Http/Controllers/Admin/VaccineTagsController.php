...
class VaccineTagsController extends Controller
{
    public function index()
    {
        ...
        return view('admin.vaccineTags.index', compact('vaccineTags'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.vaccineTags.create');
    }
    ...
    public function store(StoreVaccineTagRequest $request)
    {
        ...
        return redirect()->route('admin.vaccine-tags.index');
    }
    ...
    public function edit(VaccineTag $vaccineTag)
    {
        ...
        return view('admin.vaccineTags.edit', compact('vaccineTag'));
    }
    ...
    public function show(VaccineTag $vaccineTag)
    {
        ...
        return view('admin.vaccineTags.show', compact('vaccineTag'));
    }
