...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-illnessTagTasks">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.task.fields.appointment_date') }}
                        </th>
                        <th>
                            {{ trans('cruds.task.fields.illness_tag') }}
                        </th>
                        <th>
                            {{ trans('cruds.task.fields.vaccine_status') }}
                        </th>
                        <th>
                            &nbsp;
                        </th>
                ...
                <tbody>
                    @foreach($tasks as $key => $task)
                        <tr data-entry-id="{{ $task->id }}">
                            ...
                            <td>
                                {{ $task->illness_tag->name ?? '' }}
                            </td>
                            <td>
                                {{ $task->vaccine_status->name ?? '' }}
                            </td>
                            <td>
                                @can('task_show')
...
@endcan
  ...
  let table = $('.datatable-illnessTagTasks:not(.ajaxTable)').DataTable({ buttons: dtButtons })
