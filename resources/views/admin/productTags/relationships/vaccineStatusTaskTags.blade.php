...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-vaccineStatusTaskTags">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.taskTag.fields.date_time') }}
                        </th>
                        <th>
                            {{ trans('cruds.taskTag.fields.illness_tag') }}
                        </th>
                        <th>
                            {{ trans('cruds.taskTag.fields.vaccine_status') }}
                        </th>
                        <th>
                            &nbsp;
                        </th>
                ...
                <tbody>
                    @foreach($taskTags as $key => $taskTag)
                        <tr data-entry-id="{{ $taskTag->id }}">
                            ...
                            <td>
                                {{ $taskTag->date_time->appointment_date ?? '' }}
                            </td>
                            <td>
                                {{ $taskTag->illness_tag->name ?? '' }}
                            </td>
                            <td>
                                {{ $taskTag->vaccine_status->name ?? '' }}
                            </td>
                            <td>
                                @can('task_tag_show')
...
@endcan
  ...
  let table = $('.datatable-vaccineStatusTaskTags:not(.ajaxTable)').DataTable({ buttons: dtButtons })
