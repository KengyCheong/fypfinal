    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.vaccine-tags.update", [$vaccineTag->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required">{{ trans('cruds.vaccineTag.fields.vaccine_status') }}</label>
                            <select class="form-control" name="vaccine_status" id="vaccine_status" required>
